...
<head>
	<title>Module Selection-Junk</title>
	...
	{	
		...
		xmlhttp.open("GET","module-selection-modified.php?cat="+ subID +"&type=1",true); //type=1 always for junk
...
<body>
	...
	<script language="javascript">
		...
		document.getElementById("junk").onmouseout=""; //remove the mouseout event so that it does not change back when hovering
	</script>
