...
<head>
	...
	{	
		...
		//this loop sets all of the buttons to their default, unselected style										//number of categories for this type
		while(categories >= 0){
...
<body>
	...
	<script language="javascript">
		...
		document.getElementById("lego").style.backgroundImage="url('images/button-down.png')"; //change the background image to let users know that they are on this module selection page
		document.getElementById("lego").onmouseout=""; //remove the mouseout event so that it does not change back when hovering
	</script>
