...
<head>
	<title>Module Selection-Code</title>
...
<body>
	...
	<script language="javascript">
		...
		document.getElementById("programming").onmouseout=""; //remove the mouseout event so that it does not change back when hovering
	</script>
