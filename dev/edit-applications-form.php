...
<?php
	...
	$overview = mysqli_fetch_array($temp);//fetch the first row, because it is the overview
	$id = $overview["ID"]; //get the unique id of the overview
	...
	//NOTE: fetch array is being used here to get the id of each app, which is used to identify it and update it in the database
		$id = $app["ID"];
		$count++;
